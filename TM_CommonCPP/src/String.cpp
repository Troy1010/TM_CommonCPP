...
namespace TMC
{
	std::string Str::to_string_hex(int iInt)
	{
		std::stringstream s;
		s << "0x" << std::hex << iInt;
		return s.str();
	...
	std::string Str::string_repeat(int n, std::string s) {
	...
	std::vector<std::string> Str::SplitString(const std::string& sString, std::string &sDelimiter, int iMaxSplit)
	{
	...
	std::vector<std::string> Str::SplitString(const std::string& sString, const char* sDelimiter, int iMaxSplit)
	{
	...
	std::vector<std::string> Str::RSplitString(const std::string& sString, std::string &sDelimiter, int iMaxSplit)
	{
		std::vector<std::string> cReturningStrings;
	...
	std::vector<std::string> Str::RSplitString(const std::string& sString, const char* sDelimiter, int iMaxSplit)
	{
		std::string sTemp = std::string(sDelimiter);
